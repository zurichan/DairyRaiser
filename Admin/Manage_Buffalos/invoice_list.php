...
<div class="border-bottom d-flex flex-row justify-content-between align-items-center overflow-hidden pb-2 mb-3">
   <div class="d-flex justify-content-center align-items-center flex-row">
      ...
      <div
         class=" d-flex flex-column justify-content-center align-items-center py-2 px-4 rounded bg-primary text-light">
         ...
         <div class="d-flex flex-row justify-content-between align-items-center text-light">
            ...
            <h1 class="lead py-0 opacity-75 text-center d-flex justify-content-between align-items-center  me-4"
               style="font-size: 12px;">Sold Buffalo <i class="bi bi-coin mx-1"></i> : <span
                  class="ms-1 fw-bold"><?= $sold_buffalo_row; ?></span></h1>
            <h1 class="lead py-0 opacity-75 text-center d-flex justify-content-between align-items-center  me-4"
   ...
   <div class="modal fade" id="CreateInvoice" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
         <form class="modal-content" method="POST" action="../process/process-invoice.php"
               ...
               <div class="mb-3">
                  ...
                  <div class="w-100 d-flex justify-content-center align-items-stretch">
                     <div class="form-check me-3">
                        <input class="form-check-input" type="radio" name="selectInvoiceCategory" id="buffaloInvoice"
                           checked>
