...
<div class="border-bottom d-flex flex-row justify-content-between align-items-center overflow-hidden pb-2 mb-3">
   <div class="d-flex justify-content-start align-items-center flex-row">
      ...
      <div class="d-flex flex-column justify-content-center align-items-start me-5">
         ...
         <div class="nav-item d-flex flex-row justify-content-center align-items-center">
            ...
            <a class="btn btn-sm btn-outline-primary <?php if (isset($_GET['page']) && $page == 'all') echo 'active'; ?> p-1 me-2"
               href="./buffalo_list.php?page=all">All</a></li>
            <a class="btn btn-sm btn-outline-primary <?php if (isset($_GET['page']) && $page == 'in_sick') echo 'active'; ?> p-1 me-2"
               href="./buffalo_list.php?page=in_sick">Sick</a>
            <a class="btn btn-sm btn-outline-primary <?php if (isset($_GET['page']) && $page == 'deceased') echo 'active'; ?> p-1 me-2"
               href="./buffalo_list.php?page=deceased">Deceased</a>
         </div>
      </div>
      <div
         class="ms-1 d-flex flex-column justify-content-center align-items-center py-2 px-4 rounded bg-primary text-light">
         <h1 class="lead py-0 mb-3" style="font-size: 27px;">Total Buffalo <i class="bi bi-check2-circle"></i> <span
               class="ms-4">:</span> <span class="fw-bold ms-2"><?= $total_buffalo; ?></span></h1>
         <div class="d-flex flex-row justify-content-between align-items-center text-light">
            <h1 class="lead py-0 opacity-75 text-center d-flex justify-content-between align-items-center  me-4"
               style="font-size: 12px;">Male <i class="mx-1 bi bi-gender-male"></i> : <span
                  class="ms-1 fw-bold"><?= $male_buffalo; ?></span></h1>
            <h1 class="lead py-0 opacity-75 text-center d-flex justify-content-between align-items-center  me-4"
               style="font-size: 12px;">Female <i class="mx-1 bi bi-gender-female"></i> : <span
                  class="ms-1 fw-bold"><?= $female_buffalo; ?></span></h1>
            <h1 class="lead py-0 opacity-75 text-center d-flex justify-content-between align-items-center  me-4"
               style="font-size: 12px;">Sick
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  class="mx-1 bi bi-virus2" viewBox="0 0 16 16">
            ...
            <h1 class="lead py-0 opacity-75 text-center d-flex justify-content-between align-items-center "
               style="font-size: 12px;">Deceased <i class="mx-1 bi bi-x-circle"></i> : <span
                  class="ms-1 fw-bold"><?= $deceased_buffalo; ?></span></h1>
         </div>
      </div>
   </div>
   ...
   <div class="">
      <button type="button" class=" btn btn-primary" id="add-buffalo-btn" data-bs-toggle="modal"
         data-bs-target="#add-buffalo"><i class="bi bi-patch-plus me-2"></i>Add New Buffalo</button>
   </div>
   <?php } ?>
</div>
...
?>
<!-- Add -->
<div class="modal fade" id="add-buffalo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <form class="modal-content" method="POST" action="../process/process-buffalo.php" enctype="multipart/form-data">
         ...
         <div class="modal-body">
            ...
            <input type="date" class="form-control mb-5" value="<?= $birthdate; ?>" name="buffalo_birthdate"
               id="buffalo_birthdate" required>
         ...
         <div class="modal-footer">
            ...
            <button type="submit" id="add-matured-buffalo" name="add-matured-buffalo"
...
<!-- Update -->
<div class="modal fade" id="update_buffalo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
   aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <form class="modal-content" method="POST" action="../process/process-buffalo.php" enctype="multipart/form-data">
         <div class="modal-header">
...
<div class="table-responsive">
   <table class="table table-bordered table-hover table-striped" id="buffaloTable"
         ...
         <tr>
            ...
            <td>
               ...
               <ul class="dropdown-menu dropdown-sm">
                  <li><button type="button" class="dropdown-item" data-bs-target="#update_buffalo"
                        data-bs-toggle="modal" data-btn="update_btn">Update</button></li>
                  <li><button type="button" class="dropdown-item" data-btn="marked_sick_btn">Marked As Sick</button>
                  </li>
                  <li><button type="button" class="dropdown-item" data-btn="marked_deceased_btn">Marked As
                        Deceased</button></li>
...
<!-- DECEASED CONTENT -->
<div class="table-responsive">
   <table class="table table-bordered table-hover table-striped" id="deceasedTable"
      style="width: 100%; font-size: 14px;">
      <thead>
         <tr>
            <th>#</th>
               ...
               if (willDelete) {
                  $.ajax({
                     ...
                     success: ((response) => {
                        ...
                        buffalo_id = Array.from($('[data-target="buffalo_id"]'));
                        remove_btn = Array.from($('[data-btn="remove_sick_btn"]'));
                        marked_btn = Array.from($(
                           '[data-btn="marked_healthy_btn"]'));
               ...
               if (willDelete) {
                  $.ajax({
                     ...
                     success: ((response) => {
                        ...
                        remove_btn = Array.from($(
                           '[data-btn="remove_buffalo_btn"]'));
                        buffalo_id = Array.from($('[data-target="buffalo_id"]'));
