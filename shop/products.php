...
<?php if (isset($page) && $page == 'all') { ?>
    ...
    <main style="margin-top: 55px;" class="bg-light container-fluid p-4">
        <div class=" mb-1 d-flex flex-column justify-content-center align-items-center gap-1">
            ...
            <h5 style="font-family: Aquino; letter-spacing: 6px;" class="text-center first-letter-head">This is Sob Title.</h5>
        ...
        <div style="background-color: #fff;" class="border d-flex justify-content-between align-items-start p-3 gap-4">
            <div class="mx-0 border-top border-bottom py-3 h-100">
                <h5 style="white-space: nowrap;font-family: Public Sans Light;" class="text-center border-bottom pb-3">Category <i class="bi bi-tags text-primary"></i> :</h5>
            ...
            <div class=" pt-0 pb-3 px-2 border-start row d-flex justify-content-start align-items-start p-0">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <button type="button" class="btn bt-sm btn-dark rounded-pill py-0" id="help-tooltip-shop" data-bs-toggle="tooltip" data-bs-placement="left" title="This is a ToolTip Help Button."><i class="bi bi-info-lg p-0"></i></button>
                </div>
                <?php
                ...
                ?>
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="card product-item">
                                <a class="text-dark text-decoration-none px-0 py-0" href="./products.php?page=item&item=<?= $product->productname; ?>">
                                    <img src="./img/<?= $product->img_url; ?>" class="product-image img-fluid" alt="product">
                                    <div class="border-top border-primary card-body text-center px-1 w-100" style="font-family: Public Sans Light;font-size: 13px;white-space: no-wrap;">
                    ...
                    ?>
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <a class="card product-item btn btn-outline-secondary disabled text-decoration-none text-dark px-0 py-0" href="./products.php?page=item&item=<?= $product->productname; ?>" tabindex="-1" role="button" aria-disabled="true">
                                <div class="d-flex flex-column justify-content-center align-items-center border  h-100">
                                    ...
                                    <p class="mb-4 text-center my-0" style="font-family: Public Sans ExBold; font-size: 15px;">Out of Stock</p>
                                </div>
                                <div class="border-top card-body d-flex flex-column justify-content-center align-items-center px-2 gap-1 h-100 w-100" style="font-family: Public Sans Light;font-size: 12px;white-space: no-wrap;">
                ...
                <main class="container border mb-4" style="margin-top: 70px;">
                    <div class=" bg-light d-flex justify-content-evenly align-items-stretch px-2 py-3">
                        ...
                        <div class="border-start ps-3">
                            <form class="h-100 text-wrap d-flex flex-column justify-content-between align-items-center" style="font-family: Public Sans Light;" method="POST" action="../validation/add-to-cart-process.php">
                                <div class="border-bottom w-100 pb-4">
                                    <span class="lead text-muted" style="font-size: 14.5px;">category > milk</span>
                                    <h5 class="" style="font-family: Public Sans ExBold; font-size: 30px;"><?= $products_byName[0]->productname; ?></h5>
                                </div>
                                <div class="w-100 d-flex justify-content-between align-items-start py-3">
                                    <div class="d-flex flex-column justify-content-start align-items-start">
                                        ...
                                        <p class=" text-primary m-0" style="font-family: Public Sans ExBold;font-size: 30px">₱ <?= $products_byName[0]->price ?>.00</p>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <label class="form-label text-center text-muted" style="font-size: 14.5px;" for="quantity">quantity:</label>
                                        <div class="input-group" style="height: 15px;">
                                            ...
                                            <input type="number" name="quantity" id="quantity" class=" form-control form-control-sm text-center" style="width: 50px;" id="quantity" value="1">
                                            <button type="button" class=" input-group-text btn btn-outline-secondary increment-btn">+</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="w-100 d-flex justify-content-between align-items-center mb-4">
                                    <button type="submit" id="addtocart" class=" btn btn-primary d-flex align-items-center" name="addtocart"><i class='bx bxs-cart-add bx-tada-hover bx-sm me-2'></i> Add to Cart</button>
                                    <a href="<?= $_SERVER['HTTP_REFERER']; ?>" class="btn btn-outline-danger d-flex align-items-center"><i class='bx bx-rotate-right bx-spin-hover bx-sm me-2'></i> Go Back</a>
                                </div>
                                <div class="w-100 h-100 d-flex flex-column text-wrap border-top pt-4 pb-2">
                                    ...
                                    <p style="font-size: 14px;font-family: Public Sans Light;text-align: justify;"><?= $products_byName[0]->description; ?></p>
                                </div>
                                <div class="d-flex flex-column justify-content-between align-items-center">
                                    <p class="text-primary" style="font-size: 14px;">Available Payments:</p>
                                    <div class="row">
                                        <div class="col d-flex align-items-center">
                                            <p class="text-muted d-flex align-items-center" style="font-size: 12px;font-family: Public Sans Light;"> <i class='bx bxs-bank bx-tada-hover me-2' style="font-size: 18px;"></i> Bank</p>
                                        </div>
                                        <div class="col d-flex align-items-center">
                                            <p class="text-muted d-flex align-items-center" style="font-size: 12px;font-family: Public Sans Light;"> <i class='bx bxs-credit-card-front bx-tada-hover me-2' style="font-size: 18px;"></i> Credit / Debit</p>
                                        </div>
                                        <div class="col d-flex align-items-center">
                                            <p class="text-muted d-flex align-items-center" style="font-size: 12px;font-family: Public Sans Light;"> <i class='bx bxs-wallet bx-tada-hover me-2' style="font-size: 18px;"></i> Digital Wallet</p>
                                        </div>
                                        <div class="col d-flex align-items-center">
                                            <p class="text-muted d-flex align-items-center" style="font-size: 12px;font-family: Public Sans Light;"> <i class='bx bxs-hand bx-tada-hover me-2' style="font-size: 18px;"></i> Cash on Delivery</p>
                                        </div>
                                    </div>
                                </div>
